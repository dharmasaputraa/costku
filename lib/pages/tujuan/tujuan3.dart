...
class BuatTujuan3 extends StatefulWidget {
  const BuatTujuan3({Key? key}) : super(key: key);
  // ignore: constant_identifier_names
  static const String Add = '/tambah';
  @override
  _BuatTujuan3State createState() => _BuatTujuan3State();
}

class _BuatTujuan3State extends State<BuatTujuan3> {
